'use client'
import { Dialog, NavButton, NavigationList } from './navbar'
...
const Header = () => {
  ...
  return (
    <div
      className={`mx-auto max-w-[1300px] flex h-full w-full justify-between px-3 py-5 lg:px-10 lg:py-6 max-md:max-w-full max-md:flex-wrap md:justify-center xl:justify-between ${
        pathname === '/' ? 'hidden' : ''
      }`}
    >
