      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto lg:max-w-6xl max-w-3xl  md:text-center">
          <h2 className="text-3xl font-bold tracking-tight text-custom-color sm:text-4xl text-center">
            Become a Certified Cloud Native Applied Generative Artificial
          ...
          <p className="mt-6 paragraph-center">
            The future of Generative Artificial Intelligence and cloud-native
            computing is poised to ignite the most transformative industrial
            revolution in human history, projected to drive a{' '}
          ...
          <p className="mt-6 paragraph-center">
            ...
            Generative Artificial Intelligence (GenAI), and Physical AI. Cloud
            Native technology offers a scalable and dependable platform for
            application operation, while AI equips these applications with
            intelligent, human-like capabilities. Physical AI aims to bridge the
            gap between digital intelligence and physical capability, creating
            systems that can understand and interact with the world in a
            human-like manner. Our aim is to train you to excel as a Cloud
            Native Applied Generative and Physical AI developer globally.
          </p>
