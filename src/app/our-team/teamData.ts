...
export const team = [
  ...
  {
    name: 'Zia Khan',
    role: 'CEO of Panacloud / COO of PIAIC',
    imageUrl: ZiaKhan,
  },
  {
    name: 'Daniyal Nagori',
    role: 'CEO of PIAIC / CEO of Governor Sindh I.T Initiative',
    imageUrl: DaniyalNagori,
  },
  {
    name: 'Muhammad Qasim',
    role: 'Chief Generative AI Officer at PIAIC & GIAIC',
    imageUrl: MuhammadQasim,
  },
  {
    name: 'Ameen Alam',
