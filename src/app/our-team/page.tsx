          ...
          <div className='overflow-hidden'>
            <div className='mx-auto max-w-7xl px-6 pb-32 pt-20 lg:pt-0  lg:px-8'>
              <div className='mx-auto max-w-2xl gap-x-14 lg:mx-0 xl:flex lg:max-w-none lg:items-center'>
                ...
                <div className='mt-14 flex justify-end gap-8 sm:-mt-44 sm:justify-start lg:justify-center sm:pl-20 lg:mt-0 lg:pl-0'>
                  {/* col-1 */}
                  ...
                  {/* col-2 */}
                  <div className='mx-auto md:mx-0 w-44 flex-none space-y-8  sm:pt-52 lg:pt-36'>
