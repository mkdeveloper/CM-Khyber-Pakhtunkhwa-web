...
import SaadIrfan from '../../../public/kpk/team/saad_irfan.webp'
  ...
  return (
    <div className='bg-white'>
      <main className='isolate'>
        ...
        <div className='relative isolate -z-10'>
          ...
          <div className='overflow-hidden'>
            <div className='mx-auto max-w-7xl px-6 pb-32 pt-20 lg:pt-0  lg:px-8'>
              <div className='mx-auto max-w-2xl gap-x-14 lg:mx-0 xl:flex lg:max-w-none lg:items-center'>
                <div className='w-full max-w-3xl mx-auto lg:shrink-0 xl:max-w-2xl lg:mt-10 xl:mt-0'>
                  <h1 className='text-4xl font-bold tracking-tight text-custom-color sm:text-6xl'>
                    Preparing for the Revolutionary Era of Generative Artificial
                    Intelligence
                  </h1>
                ...
                <div className='mt-14 flex justify-end gap-4 sm:gap-6 sm:-mt-44 sm:justify-start lg:justify-center sm:pl-20 lg:mt-0 lg:pl-0'>
                  {/* col-1 */}
                  <div className='hidden sm:block ml-auto w-44 flex-none space-y-8 pt-32 sm:ml-0 sm:pt-80  lg:pt-36 xl:order-none xl:pt-80'>
                  ...
                  {/* col-2 */}
                  <div className='mx-auto md:mx-0 w-32 min-[400px]:w-40 sm:w-44 flex-none space-y-8  sm:pt-52 lg:pt-36'>
                  ...
                  {/* col-3 */}
                  <div className='w-32 min-[400px]:w-40 sm:w-44 flex-none space-y-8 pt-32 sm:pt-0'>
                    <div className='relative'>
                      <Image
                        width={500}
                        height={500}
        ...
        {/* Image section */}
        <div className='mt-32 px-6  xl:mx-auto xl:max-w-7xl xl:px-8'>
          <Image
            width={1920}
            height={1080}
            src={Lab}
